...
const JobOffer = () => {
    ...
    return (
        <div className="min-h-screen">
            <section className="relative mx-12 mt-12 rounded-lg" style={{ width: '1350px', height: '480px' }}>
                <img
                    src={jobspicture}
                    alt="bureau"
            ...
            <section className="relative mx-12 mt-12 rounded-lg" style={{ width: '1050px', height: '1150px' }}>
                <img
                    src={joboffer}
                    alt="bureau"
            ...
            <section className="bg-Lightblue text-center py-12 mt-10">
                ...
                <div className="flex justify-center space-x-6">
                    <button className="px-6 py-3 bg-Purplee text-white font-bold rounded-lg shadow-lg hover:bg-black transition duration-300">Postuler</button>
                    <button className="px-6 py-3 bg-white text-Purplee font-bold rounded-lg shadow-lg hover:bg-black transition duration-300">Sauvegarder</button>
                </div>
            </section>

            <section className="mt-10 mx-5 pb-10">
                <h2 className="text-3xl font-bold text-left ml-12 mb-4">Informatique</h2>
                <AliceCarousel
                    items={jobsInformatique.map((job, index) => (
                        <div key={index} className="relative p-4 bg-Greyy rounded-lg shadow border border-black" style={{ width: '20rem', height: '25rem' }}>
                            <img src={job.photo} alt={job.title} className="w-full h-40 object-cover mb-4 bg-white" style={{ objectFit: 'cover' }} />
